                ...
                if ($bookingNotification && $bookingNotificationType == 'firebase') {
                    try {
                        ...
                        if (isset($booking->provider_id)){
                            $topic = "goya_provider_{$zoneId}_{$booking->provider_id}_booking_message";
                        }else {
                            if ($serviceAtProviderPlace) {
                                if ($serviceLocation === 'provider') {
                                    $topic = "goya_provider_{$zoneId}_provider_booking_message";
                                }
                                if ($serviceLocation === 'customer') {
                                    $topic = "goya_provider_{$zoneId}_customer_booking_message";
                                }
                            } else {
                                $topic = "goya_provider_{$zoneId}_booking_message";
                            }
                        }
